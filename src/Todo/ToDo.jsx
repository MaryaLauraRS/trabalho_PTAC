   ...
   import { useEffect, useState } from "react";
    ...
    <div>
        ...
        <p class="text-center fs-3 font-family">Cadastre seus videos</p>

    <center>
            <form onSubmit={salvar}>
            <div class="form-floating w-50">
        <input id="floatingInput" class="form-control border-secondary"  type="text" onChange={(e)=>setAtividade4(e.target.value)}/> 
            ...
            {lista.map((atividade) => 
                    <div key={atividade.id}>
                        <span class="card card-body text-center w-25" >
                            <h4>{atividade.setAtividade4}</h4><hr/>
